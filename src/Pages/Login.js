...
export default function Login() {
    ...
    return (
        <div className="d-flex justify-content-center align-items-center mb-3 mt-3">
            ...
            <div className="rounded d-flex flex-column justify-content-start align-items-center border-dark shadow"
            ...
            <form action = "" onSubmit={handleSubmit} className="mb-2">  
                ...
                <div style={{ width: "100%", height: "25px" }} className="d-flex justify-content-between px-3">
                ...
                <div style={{ backgroundColor: "rgb(221, 221, 221)", width: "100%" }}
                ...
                <div className="flex-fill border d-flex flex-column justify-content-center align-items-center py-3"
                    style={{ width: "100%" }}>
